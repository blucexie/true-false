...
$(function () {
    $('.btn').click(function () {
      window.location.href="tfT2.html";
    });
...
//这是固定的不用改。
    ...
    function  typewrite() {
        ...
        var str = '偶尔吃一包方便面没有任何问题，不需要用任何东西“解毒”，也无需等上32天。如果担心营养不够自己往面里加一些蔬菜鸡蛋肉类就好，不过最好别配火腿肠。<br/>常吃方便面无法满足身体所需要的维生素、纤维素和矿物质等营养成分，也会造成盐分摄入过量，长期下去可能会出现便秘、营养不良、电解质紊乱、水钠潴留，甚至心血管疾病等健康问题，小孩子常吃影响身体发育。只是再忙再懒得做饭也不能天天只吃方便面，营养跟不上还可能会惹疾病上身，身体是革命的本钱！';
        var arr = [];
